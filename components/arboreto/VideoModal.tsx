...
export function VideoModal({
  ...
  return (
    <>
      <div
        className="arboreto-video-card group cursor-pointer"
        onClick={handleOpen}
        role="button"
        tabIndex={0}
        aria-label="Assistir ao vídeo de apresentação do Arboreto Eco Ville"
        onKeyDown={(e) => {
      ...
      >
        <Image
          src={posterSrc}
          alt="Lounge de frente para o lago no Arboreto Eco Ville"
          fill
          priority
          sizes="(max-width: 1024px) 92vw, 1100px"
          className="object-cover transition-transform duration-700 group-hover:scale-103"
        />
        <div className="arboreto-video-overlay" />

        {/* Centered Play Button */}
        <div className="arboreto-video-play-btn">
          <Image
            src="/arboreto/375.png"
            alt="Play"
            width={90}
            height={90}
      ...
      {isOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Vídeo do Arboreto Eco Ville"
        >
          <button
            type="button"
            onClick={handleClose}
          ...
          <div
            className="arboreto-video-modal-content"
